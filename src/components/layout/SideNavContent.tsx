...
export default function SideNavContent({ onNavigate, scrollContainerRef, onScroll }: SideNavContentProps) {
  ...
  const navLinkClass = "w-full flex items-center gap-2.5 px-4 py-3 rounded-lg transition-colors text-sm font-medium hover:bg-slate-100 active:bg-slate-100 dark:hover:bg-slate-800 dark:active:bg-slate-800 text-slate-800 dark:text-slate-200";
  const navActiveProps = { className: 'bg-slate-100 dark:bg-slate-700 text-slate-800 dark:text-slate-200' };
