...
export const FloorMap: React.FC<Props> = ({ className, onRoomSelect, activeRoomId }) => {
  ...
  return (
    ...
    >
      ...
      <g id="passive_area">
        <rect data-room-id="pc_ll" x="0" y="196.7" width="96.6" height="58.4" transform="translate(96.6 451.9) rotate(180)"/>
        <rect data-room-id="pc_2" x="375" y="196.8" width="78.5" height="58.3" transform="translate(828.5 451.9) rotate(180)"/>
        <rect data-room-id="311" x="179" y="196.7" width="56.5" height="58.4" transform="translate(414.6 451.9) rotate(180)"/>
        <rect data-room-id="310" x="235.6" y="196.7" width="39.4" height="58.4" transform="translate(510.5 451.9) rotate(180)"/>
        <rect data-room-id="309" x="275" y="196.8" width="100" height="58.3" transform="translate(650 451.9) rotate(180)"/>
