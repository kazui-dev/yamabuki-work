    ...
    >
      ...
      <g id="active_area">
		...
		<g id="icons">
			...
			<path id="icon_woman_2" d="M27,103.9A4,4,0,0,1,27,96a4,4,0,1,1,0,7.9Zm5.6,14-1.4-10a1.7,1.7,0,0,0-1.6-1.8H24.5a1.7,1.7,0,0,0-1.6,1.8l-1.4,10a1.2,1.2,0,0,0,1.2,1.4h8.7A1.2,1.2,0,0,0,32.6,117.9Z"/>
		</g>
		<g id="facilities">
